...
<head>
    ...
    <title>WakuWika - RESTAURANT FOOD MENU</title>
...
<body>
    <div class="preloader" style="display: none;"><button class="as-btn style3 preloaderCls">Cancel Preloader</button>
            ...
            <div class="container as-container">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto d-none d-xl-block">
                        <div class="header-button"><button type="button" class="icon-btn searchBoxToggler"><i class="far fa-search"></i></button> <button type="button" class="icon-btn sideMenuToggler"><i class="far fa-cart-shopping"></i> <span class="badge">5</span></button> <a href="contact.html" class="as-btn">BOOK YOUR
                                SEAT</a>
                            <div class="link-box">
                                <div class="link-box_icon"><i class="fa-light fa-phone"></i></div>
                                <div>
                                    <p class="link-box_text">Call Anytime 24/7</p><a href="%2b15048998221.html" class="link-box_link">(+150) 4899 8221</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="footer-wrapper footer-layout1 background-image" style="background-image: url(&quot;assets/img/bg/footer_bg_1.jpg&quot;);">
        <div class="container">
    ...
    </footer><a href="#" class="scrollToTop scroll-btn show"><i class="far fa-long-arrow-up"></i></a>
